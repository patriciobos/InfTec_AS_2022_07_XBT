...
\end{figure}
La corriente a través de cada colector, asumiendo que ambos transistores están en modo activo directo, está dada por la siguiente ecuación, que utiliza la nomenclatura tradicional de circuitos con transistores:
\begin{equation}
