...
Se fabricó un lote de circuitos impresos de doble capa en material FR4 con el diseño del circuito con dos fuentes de corriente para evaluar su desempeño.  El diseño del PCB y el routeo de componentes se realizó siguiendo recomendaciones generales para circuitos analógicos \citep{khandpur2006printed}. En la FIG. \ref{fig:PCB_montado} se observa un ejemplar de las placas fabricadas, con los componentes montados, integrada en el kit de desarrollo.
