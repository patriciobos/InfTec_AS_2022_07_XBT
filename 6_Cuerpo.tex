...
\noindent la diferencia de potencial entre \textit{drain} y \textit{source} del transistor JFET, Q2, que a su vez es igual a la caída de potencial en el resistor del elemento sensor de la sonda XBT, $V_{THERMISTOR}$.
