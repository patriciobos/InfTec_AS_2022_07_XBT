...
El circuito analizado, que se muestra en la FIG. \ref{fig:stegen}, es un puente auto-balanceado que utiliza un transistor de efecto de campo, JFET, realimentado para ``copiar'' permanentemente el valor de la resistencia del termistor en la sonda XBT y producir una tensión de salida linealmente proporcional a esta en todo su rango de operación. 

Se puede observar en el circuito que se utiliza una fuente de corriente constante con el transistor Q1 polarizado para suministrar $I_S = 250\; \mu A$. Esta corriente se reparte en partes iguales por las dos ramas del puente debido a que la suma de las impedancias de cada rama está precisamente apareada por diseño. En este sentido, se deben utilizar para los resistores de 10 K$\Omega$ en la parte superior del puente, resistores de precisión.
