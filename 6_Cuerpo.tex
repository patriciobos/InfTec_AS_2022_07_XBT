...
En la FIG. \ref{fig:puenteJFET_errorRth} se muestra el error relativo en la estimación de $R_{th}$, para todo el rango de valores operativo de las sonda XBT.  El error relativo máximo se da para $R_{th} = 3 k\Omega$ y es igual a 0,267.
